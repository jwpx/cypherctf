  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-r from-cyan-500 to-blue-500">
      <div className="z-10 max-w-lg w-full items-center justify-between font-mono text-sm lg:flex">
        <div class="custom-shape-divider-top-1707301947">
        ...
        <div class="max-w-lg p-8 mt-16 bg-white rounded-lg shadow-md flex flex-col items-center">
          ...
          <p class="text-lg mb-8">Submit the flag at <a href="http://www.hi.com" class="text-blue-500 underline">www.hi.com</a>.</p>
          <p class="text-sm mb-6 text-white">flag&#123;oh_sint_you_found_it&#125;</p>
        </div>
      </div>
    </main>
  );
